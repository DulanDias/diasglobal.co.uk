                  ...
                  <div className="bg-card border border-border rounded-2xl p-4 sm:p-6 lg:p-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center py-2 border-b border-border">
                        <span className="text-sm sm:text-base">Gross Annual Salary</span>
                        <span className="font-semibold text-sm sm:text-base">{formatCurrency(result.grossAnnual)}</span>
                      </div>
                    ...
                    <div className="space-y-3">
                      {result.taxBreakdown.map((bracket, index) => (
                        <div key={index} className="flex justify-between items-center">
                          <span className="text-xs sm:text-sm">{bracket.bracket}</span>
                          <span className="text-sm sm:text-base">{formatCurrency(bracket.taxAmount)}</span>
                        </div>
                      ))}
