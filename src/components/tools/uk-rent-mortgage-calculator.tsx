    ...
    <body>
      ...
      <div class="footer">
        ...
        <p style="font-size: 11px; line-height: 1.4; color: #666; margin: 10px 0;">
          <strong>IMPORTANT DISCLAIMER:</strong> This calculator is for informational purposes only and should not be considered as financial, investment, or legal advice. 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-card border border-border rounded-2xl p-4 sm:p-6 lg:p-8 sticky top-24">
            ...
            <div className="lg:col-span-2 space-y-4 lg:space-y-6">
              {result && (
                <>
                  ...
                  <div className="bg-bg border border-border rounded-2xl p-4 sm:p-6 mb-6">
